...
record HistogramDemo(Distribution distribution, Clip clipX, int samples) implements ShowProvider {
  @Override
  public Show getShow() {
    Distribution histogram = HistogramDistribution.of(RandomVariate.of(distribution, samples));
    Show show = new Show();
